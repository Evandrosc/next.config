...
const Carbs = ({ handleQuestionUpdate }) => {
  ...
  return (
    <>
              ...
              >
                <Dialog.Panel className="flex flex-col items-center justify-center w-full max-w-md gap-3 p-6 pt-4 overflow-hidden text-left transition-all transform border border-black shadow-xl bg-black/20 rounded-xl backdrop-blur-lg">
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 mb-2 text-center">
                    O consumo errado de carboidratos causa picos de insulina,
                    fazendo seu corpo armazenar gordura e ter o apetite
                    descontrolado.
                  </div>

                  <div className="flex flex-col items-center justify-center gap-2 mb-2 text-center">
                    Ajustando a quantidade de carboidratos e combinando ele da
                    maneira correta, você tem energia e disposição para lidar no
                    dia a dia enquanto perde gordura sem sofrer.
                  </div>
      ...
      >
        ...
        >
          <div className="w-full h-full bg-cover rounded-full bg-center bg-[url('/images/carbo.png')]"></div>
        </div>
        ...
        <div className="px-8 font-bold text-center text-black">
          Selecione os tipos de carboidrato que{" "}
        ...
        <ul className="grid items-center justify-center w-full grid-cols-2 grid-rows-4 gap-4 px-6 py-6">
          <li className="w-full">
            <input
              type="checkbox"
              id="activity-0"
            ...
            >
              <div className="w-full font-semibold text-center">Pão</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Tapioca</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Arroz</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Granola</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Abóbora</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Batata</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Mandioca</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Aveia</div>
            </label>
          </li>
        </ul>
        ...
        <button
          type="button"
          onClick={() => handleQuestionUpdate("fibers")}
          className="z-20 w-full px-4 mx-auto font-bold rounded-full cursor-pointer shrink-0"
        >
