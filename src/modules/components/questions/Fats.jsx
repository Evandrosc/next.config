...
const Fats = ({ handleQuestionUpdate, handlePageUpdate }) => {
  ...
  return (
    <>
              ...
              >
                <Dialog.Panel className="flex flex-col items-center justify-center w-full max-w-md gap-3 p-6 pt-4 overflow-hidden text-left transition-all transform border border-black shadow-xl bg-black/20 rounded-xl backdrop-blur-lg">
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 mb-2 text-center">
                    As gorduras cumprem funções como participar da construção
                    das células, manter a temperatura do corpo, proteger os
                    órgãos vitais, transportar vitaminas e compor as enzimas,
                    hormônios e substâncias que auxiliam o sistema imunológico.
                  </div>

                  <div className="flex flex-col items-center justify-center gap-2 mb-2 text-center">
                    O consumo correto de gorduras saudáveis acelera o processo
                    de emagrecimento.
                  </div>
      ...
      >
        ...
        >
          <div className="w-full h-full bg-cover rounded-full bg-center bg-[url('/images/gorduras.png')]"></div>
        </div>
        ...
        <div className="px-8 font-bold text-center text-black">
          Selecione os tipos de gorduras que{" "}
        ...
        <ul className="grid items-center justify-center w-full grid-cols-2 gap-4 px-6 py-6">
          <li className="w-full">
            <input
              type="checkbox"
              id="activity-0"
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Manteiga</div>
            </label>
          </li>
          ...
          <li className="w-full">
            ...
            <label
              ...
              className="flex items-center justify-center w-full p-4 text-gray-500 transition-colors border border-gray-500 rounded-lg cursor-pointer peer-checked:text-sky-500 peer-checked:border-sky-500"
            >
              <div className="w-full font-semibold text-center">Nozes</div>
            </label>
          </li>
        </ul>
        ...
        <button
          type="button"
          onClick={() => handlePageUpdate("generating")}
          className="z-20 w-full px-4 mx-auto font-bold rounded-full cursor-pointer shrink-0"
        >
